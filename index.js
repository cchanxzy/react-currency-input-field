...
/***/ "./src/components/utils/checkIsValidNumber.ts":
/*!****************************************************!*\
  !*** ./src/components/utils/checkIsValidNumber.ts ***!
  \****************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.checkIsValidNumber = void 0;
...
exports.cleanValue = function (_a) {
    var value = _a.value, _b = _a.groupSeparator, groupSeparator = _b === void 0 ? ',' : _b, _c = _a.decimalSeparator, decimalSeparator = _c === void 0 ? '.' : _c, _d = _a.allowDecimals, allowDecimals = _d === void 0 ? true : _d, _e = _a.decimalsLimit, decimalsLimit = _e === void 0 ? 2 : _e, _f = _a.allowNegativeValue, allowNegativeValue = _f === void 0 ? true : _f, prefix = _a.prefix;
    var isNegative = value.includes('-');
    var withoutNegative = isNegative ? value.replace('-', '') : value;
    var withoutPrefix = prefix ? withoutNegative.replace(prefix, '') : withoutNegative;
    ...
    if (String(parsed).includes(decimalSeparator)) {
        var _g = withoutInvalidChars.split(decimalSeparator), int = _g[0], decimals = _g[1];
...
Object.defineProperty(exports, "__esModule", { value: true });
__exportStar(__webpack_require__(/*! ./checkIsValidNumber */ "./src/components/utils/checkIsValidNumber.ts"), exports);
            ...
            react_1.default.createElement("form", { className: "needs-validation" },
                react_1.default.createElement("div", { className: "row" },
                    react_1.default.createElement("div", { className: "form-group col" },
                        ...
                        react_1.default.createElement(CurrencyInput_1.default, { id: "validationCustom01", name: "input-1", defaultValue: 999.99, className: "form-control " + className, value: value, onChange: validateValue, prefix: prefix, precision: 2 }),
                    ...
                    react_1.default.createElement("div", { className: "form-group col" },
                        react_1.default.createElement("pre", { className: "h-100 p-3 bg-dark text-white" },
                            react_1.default.createElement("div", { className: "text-muted mr-3" }, "onChange value:"),
                            rawValue)))))));
};
            ...
            react_1.default.createElement("form", { className: "needs-validation" },
                react_1.default.createElement("div", { className: "row" },
                    react_1.default.createElement("div", { className: "col" },
                        ...
                        react_1.default.createElement(CurrencyInput_1.default, { id: "validation-example-2-field", placeholder: "$1,234,567", allowDecimals: true, className: "form-control " + className, onChange: validateValue, defaultValue: 0, prefix: '$' }),
                        react_1.default.createElement("div", { className: "invalid-feedback" }, errorMessage)),
                    react_1.default.createElement("div", { className: "form-group col" },
                        react_1.default.createElement("pre", { className: "h-100 p-3 bg-dark text-white" },
                            react_1.default.createElement("div", { className: "text-muted mr-3" }, "onChange value:"),
